...
| `xref-stream-object-stream-valid.pdf` | Generated inline by the pdfv project from the M1 xref-stream/object-stream fixture shape. | MPL-2.0 | success | valid | Exercises xref stream trailer discovery and object stream materialization. |
...
xref-stream-object-stream-valid.pdf = literal bytes in this directory
```
